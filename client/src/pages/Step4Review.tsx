    ...
    <AppShell currentStage={4} rightPanel={copilotPanel}>
      <div className="p-8 max-w-5xl">
        ...
        <div className="mb-6 border border-[#000000] bg-[#000000] p-4 text-[#ffffff]">
          ...
          <div className="text-xs text-[#e2e2e2] mt-1">Carry-forward issues: {branchIssues.join(" / ")}</div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-6">
          <div className="col-span-2 space-y-5">
            ...
            <div className="border border-[#000000] p-5">
              <h2 className="text-sm font-bold text-[#000000] mb-3">B. Human Confirmation</h2>
              <div className="grid grid-cols-4 gap-3 mb-4">
                <button
                  ...
                  className={`py-2 text-xs font-bold transition-colors ${state.decisionStatus === "confirmed" ? "bg-[#000000] text-[#ffffff]" : "border border-[#777777] text-[#000000] hover:bg-[#f3f3f3]"}`}
                >
                  확정
                </button>
                <button
                  ...
                  className={`py-2 text-xs font-bold transition-colors ${state.decisionStatus === "modified" ? "bg-[#000000] text-[#ffffff]" : "border border-[#777777] text-[#000000] hover:bg-[#f3f3f3]"}`}
                >
                  수정 후 확정
                </button>
                <button
                  ...
                  className={`py-2 text-xs font-bold transition-colors ${state.decisionStatus === "rejected" ? "bg-[#ba1a1a] text-[#ffffff]" : "border border-[#ba1a1a] text-[#ba1a1a] hover:bg-[#fff5f5]"}`}
                >
                  거절
                </button>
                <button
                  ...
                  className={`py-2 text-xs font-bold transition-colors ${state.decisionStatus === "supplement_requested" ? "bg-[#000000] text-[#ffffff]" : "border border-[#777777] text-[#000000] hover:bg-[#f3f3f3]"}`}
                >
                  보완 요청
                </button>
              </div>
          ...
          <div className="space-y-5">
            <div className="border border-[#c6c6c6] bg-[#ffffff] p-4">
              <h2 className="text-sm font-bold text-[#000000] mb-3">C. Collaboration / Conditions</h2>
              <div className="space-y-2 text-xs">
                <div className="border border-[#e2e2e2] p-3 bg-[#f9f9f9]">보완 요청 상태: {state.supplementStatus}</div>
                <div className="border border-[#e2e2e2] p-3 bg-[#f9f9f9]">조건 변경 이력: 아직 없음</div>
                <div className="border border-[#e2e2e2] p-3 bg-[#f9f9f9]">공유 메모: 법무팀 협의 필요 여부 검토</div>
              </div>
            </div>

            <div className="border border-[#c6c6c6] bg-[#ffffff] p-4">
              <div className="text-[10px] font-bold text-[#5e5e5e] uppercase tracking-wide mb-2">Decision State</div>
              <div className="text-sm font-black text-[#000000] mb-1">{state.decisionStatus.toUpperCase()}</div>
          ...
          <button
            ...
            className={`px-6 py-2.5 text-sm font-bold transition-colors ${
              canAdvanceFromStep4 || state.decisionStatus === "supplement_requested"
                ? "bg-[#000000] text-[#ffffff] hover:bg-[#3a3c3c]"
                : "border border-[#c6c6c6] text-[#777777] cursor-not-allowed"
            }`}
          >
