  ...
  return (
    <AppShell currentStage={3} rightPanel={copilotPanel}>
      <div className="p-8 max-w-4xl">
        <div className="mb-7">
          <div className="text-xs font-bold text-[#6b7280] uppercase tracking-wider mb-1">Stage 3. Subordinated Branch Analysis</div>
          <h1 className="text-3xl font-black text-[#111827] tracking-tight">후순위채 세부 분석</h1>
          <p className="text-sm text-[#6b7280] mt-1.5">후순위 구조 분석 결과만 정리하고 최종 판단은 Stage 4에서 수행합니다.</p>
        </div>

        <div className="grid grid-cols-2 gap-5 mb-5">
          <div className="border border-[#e5e7eb] bg-[#ffffff] p-4">
            <h3 className="text-xs font-bold text-[#6b7280] uppercase tracking-wide mb-3">선·후순위 대출 스택</h3>
            <div className="space-y-1.5">
              ...
              <div className="flex items-center justify-between bg-[#f8f9fa] border border-[#e5e7eb] px-3 py-2.5">
                <span className="text-xs font-bold text-[#374151]">SUBORDINATED</span>
                <span className="text-sm font-black text-[#111827]">20.0%</span>
              </div>
            </div>
          </div>

          <div className="border border-[#e5e7eb] bg-[#ffffff] p-4">
            <h3 className="text-xs font-bold text-[#6b7280] uppercase tracking-wide mb-3">가산 금리 적정성</h3>
            <div className="grid grid-cols-2 gap-3">
              <div>
                <div className="text-[10px] text-[#6b7280] mb-0.5">Market Premium</div>
                <div className="text-xl font-black text-[#111827]">+2.45%</div>
              </div>
              <div>
                <div className="text-[10px] text-[#6b7280] mb-0.5">Assessed Risk</div>
                <div className="text-xl font-black text-[#111827]">+2.80%</div>
              </div>
            </div>
        ...
        <div className="border border-[#e5e7eb] bg-[#ffffff] mb-5">
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-[#e5e7eb]">
                <th className="px-4 py-2.5 text-left text-[10px] font-bold text-[#6b7280] uppercase">Rank</th>
                <th className="px-4 py-2.5 text-left text-[10px] font-bold text-[#6b7280] uppercase">Capital Type</th>
                <th className="px-4 py-2.5 text-left text-[10px] font-bold text-[#6b7280] uppercase">Priority Score</th>
                <th className="px-4 py-2.5 text-left text-[10px] font-bold text-[#6b7280] uppercase">Rights</th>
              </tr>
            </thead>
            <tbody>
              {[
                ...
                <tr key={row.rank} className="border-b border-[#e5e7eb]">
                  <td className="px-4 py-3 text-xs font-bold text-[#6b7280]">{row.rank}</td>
                  <td className="px-4 py-3 text-xs font-medium text-[#004999]">{row.type}</td>
                  <td className="px-4 py-3 text-xs font-bold text-[#374151]">{row.score}</td>
                  <td className="px-4 py-3 text-xs text-[#6b7280]">{row.rights}</td>
                </tr>
              ))}
            </tbody>
          </table>
