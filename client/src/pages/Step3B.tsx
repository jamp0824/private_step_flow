  ...
  return (
    <AppShell currentStage={3} rightPanel={copilotPanel}>
      <div className="p-8 max-w-4xl">
        <div className="mb-7">
          <div className="text-xs font-bold text-[#5e5e5e] uppercase tracking-wider mb-1">Stage 3. Subordinated Branch Analysis</div>
          <h1 className="text-3xl font-black text-[#000000] tracking-tight">후순위채 세부 분석</h1>
          <p className="text-sm text-[#5e5e5e] mt-1.5">후순위 구조 분석 결과만 정리하고 최종 판단은 Stage 4에서 수행합니다.</p>
        </div>
